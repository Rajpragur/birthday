...
$('document').ready(function(){
	...
	$(window).resize(function(){
		...
		// Responsive balloon spacing on resize
		var spacing = screenWidth > 768 ? [275, 165, 55] : 
		              screenWidth > 576 ? [140, 85, 28] : 
		              screenWidth > 400 ? [110, 66, 22] : [90, 54, 18];
		...
		$('#b44').animate({top:240, left: vw+spacing[2]},500);
		$('#b55').animate({top:240, left: vw+spacing[1]},500);
		$('#b66').animate({top:240, left: vw+spacing[0]},500);
	});
	...
	$('#play').click(function(){
		...
		$('body').css('background-color','#F4C2C2');
